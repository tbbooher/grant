  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved registration as @registration" do
        ...
        post :create, {:registration => { "email" => "invalid value" }}, valid_session
        assigns(:registration).should be_a_new(Registration)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested registration" do
        ...
        Registration.any_instance.should_receive(:update_attributes).with({ "email" => "MyString" })
        put :update, {:id => registration.to_param, :registration => { "email" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the registration as @registration" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Registration.any_instance.stub(:save).and_return(false)
        put :update, {:id => registration.to_param, :registration => { "email" => "invalid value" }}, valid_session
        assigns(:registration).should eq(registration)
      end
